...
class data_into_chart:
     ...
     def Set_Data_IntoSheet(self):
         ...
         self.MPU_datasheet.write("A34","Data_ID",self.bold)
         self.MPU_datasheet.write("B34","CubeProgrammer_Release",self.bold)
         self.MPU_datasheet.write("C34","Debit_ID",self.bold)
         ...
         self.MPU_datasheet.insert_chart('H1', chart1,{'x_scale': 1.750, 'y_scale': 1.50})
